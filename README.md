...
<img src="https://latex.codecogs.com/gif.latex?\underset{\vec{A}\in\mathbb{R}^{D\times&space;m}}{\arg\max}&space;\quad&space;f(\vec{A})&space;=&space;\text{KL}(P_{\vec{A}},&space;Q_{\vec{A}})&space;&plus;&space;\text{KL}(Q_{\vec{A}},&space;P_{\vec{A}})" title="\underset{\vec{A}\in\mathbb{R}^{D\times m}}{\arg\max} \quad f(\vec{A}) = \text{KL}(P_{\vec{A}}, Q_{\vec{A}}) + \text{KL}(Q_{\vec{A}}, P_{\vec{A}})" />
